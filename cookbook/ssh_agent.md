...
```nushell
load-env (keychain --eval <your ssh keys, eg. --quiet id_ed25519> | lines | split column ";" | get column1 | first 2 | split column "=" | rename name value | reduce -f {} {|it, acc| $acc | upsert $it.name $it.value })
```
