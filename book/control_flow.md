...
You can also have a, catch all conditions, for if the given value doesn't match any of the other conditions, by having a branch whose matching value is `_`.
