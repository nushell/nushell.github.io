---
{"version":"0.70.0\n","title":"ansi","categories":"platform","usage":"Output ANSI codes to change color.\n"}
---
<!-- THIS FILE IS GENERATED BY update_book_commands.cjs USING NUSHELL'S HELP COMMANDS.
REFRAIN FROM EDITING IT MANUALLY.-->
# <code>ansi</code> for platform

<div class='command-title'>Output ANSI codes to change color.</div>
