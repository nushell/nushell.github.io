...
To add a plugin, call the [`register`](/commands/commands/register.md) command to tell Nu where to find it. As you do, you'll need to also tell Nushell what encoding the plugin uses.
...
When [`register`](/commands/commands/register.md) is called:
