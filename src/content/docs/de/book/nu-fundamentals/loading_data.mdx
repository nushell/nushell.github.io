...
import vscode from "../../../snippets/loading_data/vscode.nu?raw";
import cargoToml from "../../../snippets/loading_data/cargo_toml.nu?raw";
import rustLangFeed from "../../../snippets/loading_data/rust_lang_feed.nu?raw";
...
<Code code={rustLangFeed} lang="nu" />
