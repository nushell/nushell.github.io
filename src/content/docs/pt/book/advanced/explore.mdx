...
import cdExample from "../../../snippets/introduction/cd_example.nu?raw";
import cdExample from "../../../snippets/introduction/cp_example.nu?raw";
import cdExample from "../../../snippets/introduction/mv_example.nu?raw";
