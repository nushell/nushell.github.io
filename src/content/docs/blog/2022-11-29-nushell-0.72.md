...
description: Today, we're releasing version 0.72 of Nu. This release includes many new features include mutability, looping, early returns, changes to the core commands, and much more.
---
