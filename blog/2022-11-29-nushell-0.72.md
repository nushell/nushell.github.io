...
- `seq` and `seq char` no longer return strings and related flags have been removed ([#7045](https://github.com/nushell/nushell/pull/7045), [#7054](https://github.com/nushell/nushell/pull/7054)). `str join` can be used to accomplish the same effect as the `--separator` flag.
