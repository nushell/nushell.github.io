...
@fdncred [added a fun way to create SQLite databases](https://github.com/nushell/nushell/pull/6266):
...
@fdncred [worked with @Tyriar from the Visual Studio Code team on shell integration](https://github.com/nushell/nushell/pull/6087). Now Nushell will display round blue/red/gray decorations indicating the start of commands in the [VS Code terminal](https://code.visualstudio.com/docs/terminal/shell-integration):
