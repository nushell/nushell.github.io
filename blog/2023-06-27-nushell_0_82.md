...
- [#9509](https://github.com/nushell/nushell/pull/9509) cratification: move the bytes command to nu-cmd-extra
- [#9496](https://github.com/nushell/nushell/pull/9496) clean up config by removing legacy options
