...
Today, we're releasing version 0.92 of Nu. This release adds exciting new plugin features (e.g., persistence), support for XDG_CONFIG_HOME, scoped file redirections, and changes to external command output.
