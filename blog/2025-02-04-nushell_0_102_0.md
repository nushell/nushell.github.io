...
They are analogous to `in` and `not-in`, with the order of operands switched. This makes certain operations more ergonomic.
...
Similarly in [#14666](https://github.com/nushell/nushell/pull/14666), [@cptpiepmatz](https://github.com/cptpiepmatz) updated the `config nu` command to add `content_type` metadata.
