...
### Fix: Pressing <kbd>Esc</kbd> or <kbd>Q</kbd> was not closing `explore`
...
Previously, custom values were being stringified in tables.
[#14760](https://github.com/nushell/nushell/pull/14760) expands these to display as Nushell values
...
- `du` now streams - Thanks [@WindSoilder](https://github.com/WindSoilder)! ([#14665](https://github.com/nushell/nushell/pull/14665))
- `get` and `reject` now support streaming - Thanks [@cosineblast](https://github.com/cosineblast)! ([#14622](https://github.com/nushell/nushell/pull/14622))
