...
- [*Themes of this release / New features*](#themes-of-this-release-new-features-toc)
    - [*Hall of fame*](#hall-of-fame-toc)
        ...
        - [*Internal changes*](#internal-changes-toc)
        - [*Platform support*](#platform-support-toc)
        - [*Making errors better*](#making-errors-better-toc)
    - [*The type system*](#the-type-system-toc)
    - [*Improving the completions in the REPL*](#improving-the-completions-in-the-repl-toc)
    - [*Some news with the standard library*](#some-news-with-the-standard-library-toc)
    - [*Miscellaneous*](#miscellaneous-toc)
    - [*Our set of commands is evolving*](#our-set-of-commands-is-evolving-toc)
        ...
        - [*Changes to existing commands*](#changes-to-existing-commands-toc)
            - [*A few updates on the `explore` command*](#a-few-updates-on-the-explore-command-toc)
...
Nushell now supports the *keyboard enhancement protocol* from [Kitty](https://sw.kovidgoyal.net/kitty/)
...
- [amtoine](https://github.com/amtoine) created
    ...
    - [add a section about *after the release* in the release README](https://github.com/nushell/nu_scripts/pull/560)
