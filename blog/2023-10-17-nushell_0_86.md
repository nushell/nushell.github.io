...
| author                                             | title                                                                        | pr                                                      |
| -------------------------------------------------- | ---------------------------------------------------------------------------- | ------------------------------------------------------- |
| [@sholderbach](https://github.com/sholderbach)     | Bump to `0.85.1` development version                                         | [#10431](https://github.com/nushell/nushell/pull/10431) |
| [@WindSoilder](https://github.com/WindSoilder)     | update lock file                                                             | [#10437](https://github.com/nushell/nushell/pull/10437) |
...
| [@stormasm](https://github.com/stormasm)           | update the doc in toolchain.toml describing the update plan                  | [#10453](https://github.com/nushell/nushell/pull/10453) |
...
| [@sholderbach](https://github.com/sholderbach)     | Bump `dialoguer` to `0.11.0`                                                 | [#10510](https://github.com/nushell/nushell/pull/10510) |
...
| [@fdncred](https://github.com/fdncred)             | bump rust-toolchain to 1.71.1                                                | [#10634](https://github.com/nushell/nushell/pull/10634) |
...
| [@sholderbach](https://github.com/sholderbach)     | Update `polars` to `0.33`                                                    | [#10672](https://github.com/nushell/nushell/pull/10672) |
