...
- `table`s can now be annotated, just as `record`s and `list`s can, thansk to [#9613](https://github.com/nushell/nushell/pull/9613)
- subtyping has been improved in [#9614](https://github.com/nushell/nushell/pull/9614) and allow to match structured types regardless of the orders of the fields
...
# Breaking changes
- [#9739](https://github.com/nushell/nushell/pull/9739) Fix output signature of `split chars`/`words`
- [#9736](https://github.com/nushell/nushell/pull/9736) Add functions for each `Value` case
