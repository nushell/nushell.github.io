...
excerpt: Today, we're releasing version 0.75 of Nu. This release extends our unicode escapes in strings, allows iterating strings by graphemes, adds a new command, and improves our module system. It also contains a good amount of polish and refactoring behind the scenes.
---
...
Today, we're releasing version 0.75 of Nu. This release extends our unicode escapes in strings, allows iterating strings by graphemes, adds a new command, and improves our module system. It also contains a good amount of polish and refactoring behind the scenes.
