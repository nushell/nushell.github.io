...
[39m
  [31m×[39m Can't convert to int.
   ╭─[[1m[4m[36mHost Environment Variables:1:1[22m[24m[39m]
...
[39m
  [31m×[39m Type mismatch.
   ╭─[[1m[4m[36mrepl_entry #3:1:17[22m[24m[39m]
...
[39m
  [31m×[39m Can't convert to int.
   ╭─[[1m[4m[36mrepl_entry #5:1:24[22m[24m[39m]
...
[39m
 ...
 [2m1[22m │ let stuff: any = {foo: "bar"}
   ...
   ╰────
   ╭─[[1m[4m[36mrepl_entry #7:1:4[22m[24m[39m]
 [2m1[22m │ $x = $stuff.foo
   · [1m[33m   ┬[22m[39m
...
[39m
  [31m×[39m The '++' operator does not work on values of type 'nothing'.
   ╭─[[1m[4m[36mrepl_entry #8:2:5[22m[24m[39m]
