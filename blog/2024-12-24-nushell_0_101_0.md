...
- [_Changes_](#changes-toc)
  ...
  - [_Breaking changes_](#breaking-changes-toc)
    ...
    - [_`table` formatting and the `display_output` hook_](#table-formatting-and-the-display-output-hook-toc)
  ...
  - [_Removals_](#removals-toc)
    - [_`NU_DISABLE_IR`_](#nu-disable-ir-toc)
...
## Simplified Startup Configuration [[toc](#table-of-contents)]
...
### Related Startup Config Changes [[toc](#table-of-contents)]
...
### Breaking Startup Config Changes [[toc](#table-of-contents)]
...
### `path self` [[toc](#table-of-contents)]
...
### `chunk-by` [[toc](#table-of-contents)]
...
### `term query` [[toc](#table-of-contents)]
...
### `merge deep` [[toc](#table-of-contents)]
...
### WASM support [[toc](#table-of-contents)]
...
### `sys net` columns [[toc](#table-of-contents)]
...
### Raw string pattern matching [[toc](#table-of-contents)]
...
### Duration/Date Arithmetic [[toc](#table-of-contents)]
...
### `explore` keybinds [[toc](#table-of-contents)]
...
### PowerShell script invocation on Windows [[toc](#table-of-contents)]
...
### New introspection tools [[toc](#table-of-contents)]
...
### `++` operator [[toc](#table-of-contents)]
...
### Stricter command signature parsing [[toc](#table-of-contents)]
...
### `group-by` [[toc](#table-of-contents)]
...
### `from csv` and `from tsv` [[toc](#table-of-contents)]
...
### `std/iter scan` [[toc](#table-of-contents)]
...
### Completion sorting [[toc](#table-of-contents)]
...
### Import module naming [[toc](#table-of-contents)]
...
### `table` formatting and the `display_output` hook [[toc](#table-of-contents)]
...
### `du` flag changes [[toc](#table-of-contents)]
...
### Code specific environment variables updated during `source` [[toc](#table-of-contents)]
...
### `date to-record` and `date to-table` [[toc](#table-of-contents)]
...
### `do --ignore-shell-errors` and `--ignore-program-errors` [[toc](#table-of-contents)]
...
### `NU_DISABLE_IR` [[toc](#table-of-contents)]
...
### `from` commands [[toc](#table-of-contents)]
...
### Completions on custom commands [[toc](#table-of-contents)]
...
### `seq char` [[toc](#table-of-contents)]
...
### `http` multipart [[toc](#table-of-contents)]
...
### `scope variables` [[toc](#table-of-contents)]
...
### `help` system [[toc](#table-of-contents)]
