...
When we removed a command we will now properly refer to it as removal and started adding warnings where appropriate (e.g. `str replace --strings`). As part of this update we removed some very old error helpers nudging you to upgrade to new commands.
