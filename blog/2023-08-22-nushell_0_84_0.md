...
WindSoilder    ||   9821 || fix append signature
jntrnr         ||   9827 || Fix the implied collect type to 'any'
jntrnr         ||   9828 || Fix prepend type, fix typos
sholderbach    ||   9829 || Fix signature of `split row`
sholderbach    ||   9824 || Bump `trash` in lockfile due to yank
amtoine        ||   9822 || change signature of `enumerate` to `any -> table`
amtoine        ||   9823 || allow `print` to take data as input again
sholderbach    ||   9836 || Narrow signature of `math ceil`/`floor`
jntrnr         ||   9842 || Fix transpose input/output types
sholderbach    ||   9830 || Fix `math min`/`max` signatures
sholderbach    ||   9843 || Fix type signature of median
sholderbach    ||   9844 || Fix signature for `math abs`
sholderbach    ||   9847 || Fix signature for `math sum`
sholderbach    ||   9845 || Fix `math log` signature
sholderbach    ||   9846 || Fix signature for `math mode`
ayax79         ||   9858 || merging into one `dfr into-nu` command
fdncred        ||   9866 || bump to dev version 0.83.2
