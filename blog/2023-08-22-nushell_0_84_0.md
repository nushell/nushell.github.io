...
- [amtoine](https://github.com/amtoine) created
    ...
    - [give real links to our GitHub contributors](https://github.com/nushell/nushell.github.io/pull/989)
...
- [gregokent](https://github.com/gregokent) created
    - [tweak `overlay new` tip](https://github.com/nushell/nushell.github.io/pull/992)
- [WindSoilder](https://github.com/WindSoilder) created
    - [update doc about env assignment](https://github.com/nushell/nushell.github.io/pull/991)
- [mike-ninja](https://github.com/mike-ninja) created
    - [Updated the oh-my-posh setup guide](https://github.com/nushell/nushell.github.io/pull/990)
...
- [amtoine](https://github.com/amtoine) created
    ...
    - [add a script to bump the version of Nushell](https://github.com/nushell/nu_scripts/pull/565)
...
- [kjelly](https://github.com/kjelly) created
    - [Add descriptions for the docker module.](https://github.com/nushell/nu_scripts/pull/549)
