...
- deprecation of `filter`, update of `where`
...
- deprecation system with `@deprecated`
    <!-- TODO: remove these tables after proper text segments -->
    |author|title|link|
    |-|-|-|
...
- new `iter` module and `recurse` command
    <!-- TODO: remove these tables after proper text segments -->
    |author|title|link|
    |-|-|-|
