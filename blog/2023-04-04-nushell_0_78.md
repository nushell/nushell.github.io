...
We no longer [automatically print loop values](https://github.com/nushell/nushell/pull/8618), and we no longer [print the results of every line automatically, requiring you to do it manually](https://github.com/nushell/nushell/pull/8292)
