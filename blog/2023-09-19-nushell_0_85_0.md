...
excerpt: Today, we're releasing version 0.85 of Nu. This release adds the first uutils command, unlocks more constant evaluation at parse time, and polishes many commands.
---
...
| [@sophiajt](https://github.com/sophiajt) | fix 'let' to properly redirect | [#10360](https://github.com/nushell/nushell/pull/10360) |
...
[@sophiajt](https://github.com/sophiajt) made the behaviour of `echo` a bit more general
...
- [`std formats from ndjson`](https://github.com/nushell/nushell/pull/10283) as a way to directly open newline-delimited JSON records. You can use `open` for files with the `.ndjson` ending if you `use std formats "from ndjson"`.
...
- [Tiggax](https://github.com/Tiggax) created
  ...
  - [update `reject` to be able to receive arg list](https://github.com/nushell/nushell/pull/10216)
