...
- [_Themes of this release / New features_](#themes-of-this-release-new-features-toc) - [_Handling globs for variables_](#handling-globs-for-variables) - [_Plugin protocol overhaul_](#plugin-protocol-overhaul) - [_Stderr pipeling support_](#stderr-pipeling-support) - [_REPL stability and panic recovery_](#repl-stability-and-panic-recovery-toc) - [_Hall of fame_](#hall-of-fame-toc) - [_Bug fixes_](#bug-fixes-toc) - [_Enhancing the documentation_](#enhancing-the-documentation-toc) - [_Our set of commands is evolving_](#our-set-of-commands-is-evolving-toc) - [_New commands_](#new-commands-toc) - [_`tee`_](#tee) - [_`interleave`_](#interleave) - [_`is-not-empty`_](#is-not-empty) - [_`commandline`_](#commandline) - [_Changes to existing commands_](#changes-to-existing-commands-toc) - [_`zip` supports closures_](#zip-supports-closures) - [_`bits` supports binary values_](#bits-supports-binary-values) - [_`into int --signed`_](#into-int-signed) - [_Migrating more commands to use `uutils`_](#migrating-more-commands-to-use-uutils) - [_List spreading for filesystem commands_](#list-spreading-for-filesystem-commands) - [_Duplicate record keys now error_](#duplicate-record-keys-now-error) - [_Removing list of cell path support_](#removing-list-of-cell-path-support) - [_Deprecated commands_](#deprecated-commands-toc) - [_Removed commands_](#removed-commands-toc)
