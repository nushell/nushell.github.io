...
excerpt: Today, we're releasing version 0.91.0 of Nu. This release adds changes to globing, an overhaul to the plugin protocol, support for piping command stderr, and two new commands!
---
...
an overhaul to the plugin protocol, support for piping command stderr, and two new commands!
...
Thanks to the work of [@devyn](https://github.com/devyn), this release adds two new commands!
