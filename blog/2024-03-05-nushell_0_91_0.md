...
- [_Themes of this release / New features_](#themes-of-this-release-new-features-toc) - [_Plugin protocol overhaul_](#plugin-protocol-overhaul) - [_Hall of fame_](#hall-of-fame-toc) - [_Bug fixes_](#bug-fixes-toc) - [_Enhancing the documentation_](#enhancing-the-documentation-toc) - [_Our set of commands is evolving_](#our-set-of-commands-is-evolving-toc) - [_New commands_](#new-commands-toc) - [_`tee`_](#tee) - [_`interleave`_](#interleave) - [_Changes to existing commands_](#changes-to-existing-commands-toc) - [_`zip` supports closures_](#zip-supports-closures) - [_Deprecated commands_](#deprecated-commands-toc) - [_Removed commands_](#removed-commands-toc)
