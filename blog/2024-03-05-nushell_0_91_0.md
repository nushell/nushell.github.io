...
With [#11195](https://github.com/nushell/nushell/pull/11858), `rm`, `open`, and `touch` no longer have a required positional parameter and now only have a rest parameter.
