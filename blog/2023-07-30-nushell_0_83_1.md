...
Due to the complexity of reworking this and the dataframe being a tier two feature in Nushell, we won't be able to fully fix this with this patch release.
