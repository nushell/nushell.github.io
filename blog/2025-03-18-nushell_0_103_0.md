...
excerpt: Today, we're releasing version 0.103.0 of Nu. This release adds support for spawning background jobs, attaching attributes to custom commands, official `.deb`, `.apk`, and `.rpm` packages, a number of Vi-mode enhancements, new proposed commands in the `std-rfc` module, and much more.
---
...
official `.deb`, `.apk`, and `.rpm` packages, a number of Vi-mode enhancements, new proposed commands in the `std-rfc` module, and much more.
