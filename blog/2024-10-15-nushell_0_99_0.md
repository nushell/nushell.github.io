...
See the [`sort-by` section](#sort-by-and-sort-toc) below.
...
[#13842](https://github.com/nushell/nushell/pull/13842): Starting with the next release, Nushell will no longer automatically loads the `std/dirs` aliases at startup. In 0.99.0, using one of these aliases (`n`, `p`, `g`, `enter`, `dexit`, or `shells`) will result in a warning message.
