...
- [*Themes of this release / New features*](#themes-of-this-release-new-features-toc)
    ...
    - [*New _spread_ operator for list and record literals*](#new-spread-operator-for-list-and-record-literals-toc)
    - [*Show found externals via syntax highlighting in the REPL*](#show-found-externals-via-syntax-highlighting-in-the-repl-toc)
    - [*Passing boolean switches dynamically*](#passing-boolean-switches-dynamically-toc)
    - [*Need help to wrap... commands?*](#need-help-to-wrap-commands-toc)
    - [*Redirection to standard streams is getting better*](#redirection-to-standard-streams-is-getting-better-toc)
    - [*Restricting use of internal variables*](#restricting-use-of-internal-variables-toc)
    - [*A small update on the LSP*](#a-small-update-on-the-lsp-toc)
    - [*One-time theming of tables is there*](#one-time-theming-of-tables-is-there-toc)
    - [*Parsing human-friendly dates into Nushell values*](#parsing-human-friendly-dates-into-nushell-values-toc)
    - [*New "out of bound" error*](#new-out-of-bound-error-toc)
    - [*Exposing name of script to the wild*](#exposing-name-of-script-to-the-wild-toc)
    - [*Details on the `0.87.1` hotfix release*](#details-on-the-0-87-1-hotfix-release-toc)
