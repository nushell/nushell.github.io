...
## New _spread_ operator for list and record literals
...
## Show found externals via syntax highlighting in the [REPL](https://en.wikipedia.org/wiki/Read%E2%80%93eval%E2%80%93print_loop)
...
| [@schrieveslaach](https://github.com/schrieveslaach)     | Implement LSP Text Document Synchronization                                                       | [#10941](https://github.com/nushell/nushell/pull/10941) |
| [@zhiburt](https://github.com/zhiburt)                   | nu-table/ Add `-t/theme` argument && Replace `-n/start-number` with `-i/index`                    | [#11058](https://github.com/nushell/nushell/pull/11058) |
| [@fdncred](https://github.com/fdncred)                   | allow parsing of human readable datetimes                                                         | [#11051](https://github.com/nushell/nushell/pull/11051) |
...
| [@amtoine](https://github.com/amtoine)                   | remove `extern-wrapped` and `export extern-wrapped`                                               | [#11000](https://github.com/nushell/nushell/pull/11000) |
| [@amtoine](https://github.com/amtoine)                   | remove `--not` from `glob`                                                                        | [#10839](https://github.com/nushell/nushell/pull/10839) |
| [@amtoine](https://github.com/amtoine)                   | remove `size` command in favor of `str stats`                                                     | [#10784](https://github.com/nushell/nushell/pull/10784) |
| [@amtoine](https://github.com/amtoine)                   | remove the `unfold` command                                                                       | [#10773](https://github.com/nushell/nushell/pull/10773) |
| [@WindSoilder](https://github.com/WindSoilder)           | std: add cross platform null-device name                                                          | [#11070](https://github.com/nushell/nushell/pull/11070) |
| [@tskinn](https://github.com/tskinn)                     | Add `mktemp` command                                                                              | [#11005](https://github.com/nushell/nushell/pull/11005) |
| [@amtoine](https://github.com/amtoine)                   | remove `def-env` and `export def-env`                                                             | [#10999](https://github.com/nushell/nushell/pull/10999) |
