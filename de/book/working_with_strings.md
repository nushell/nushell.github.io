...
Der [`split row`](/commands/commands/split_row.md) Befehl erstellt eine Liste aus einem Text,
...
Der [`split column`](/commands/commands/split_column.md) Befehl erstellt eine Tabelle aus einem Text,
...
Schliesslich trennt der [`split chars`](/commands/commands/split_chars.md) Befehl
...
Die Seiten eines Textes werden mit dem [`str trim`](/commands/commands/str_trim.md) Befehl
geschnitten. Standardmässig schneidet der [`str trim`](/commands/commands/str_trim.md) Befehl
...
Mit den Befehlen `[str lpad`](/commands/commands/str_lpad.md) und [`str rpad`](/commands/commands/str_rpad.md)
...
Dies kann mit dem [`str reverse`](/commands/commands/str_reverse.md) Befehl ganz einfach erreicht werden.
...
Mit dem [`parse`](/commands/commands/parse.md) Befehl können Texte in Spalten geparst werden.
Zum Beispiel:
...
1. Mit [`into string`](/commands/commands/into_string.md). e.g. `123 | into string`
2. Mit Text Interpolation. e.g. `$'(123)'`
3. Mit [`build-string`](/commands/commands/build-string.md). e.g. `build-string (123)`

### Von einem Text

1. Mit [`into <type>`](/commands/commands/into.md). e.g. `'123' | into int`

## Texte einfärben

Texte können eingefärbt werden mit dem [`ansi`](/commands/commands/ansi.md) Befehl
Zum Beispiel:
