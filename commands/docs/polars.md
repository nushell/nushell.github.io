...
| [`polars into-nu`](/commands/docs/polars_into-nu.md)                 | Converts a dataframe or an expression into into nushell value for access and exploration.        | plugin |
...
| [`polars to-arrow`](/commands/docs/polars_to-arrow.md)               | Saves dataframe to arrow file.                                                                   | plugin |
| [`polars to-avro`](/commands/docs/polars_to-avro.md)                 | Saves dataframe to avro file.                                                                    | plugin |
| [`polars to-csv`](/commands/docs/polars_to-csv.md)                   | Saves dataframe to CSV file.                                                                     | plugin |
